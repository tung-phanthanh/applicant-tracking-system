        ...
        return (
            <div className="flex flex-col items-center gap-4 text-center">
                ...
                <p className="text-sm text-muted-foreground">
                    This activation link is missing or malformed. Please check your email and try again.
                </p>
    ...
    return (
        <div className="w-full max-w-sm space-y-6">
            <div className="space-y-1 text-center">
                ...
                <p className="text-sm text-muted-foreground">Set a password to complete your account setup.</p>
            </div>
