...
// public static byte[] generate(Offer offer, String candidateName, String
// jobTitle) {
...
// Font titleFont = new Font(Font.HELVETICA, 20, Font.BOLD, new Color(33, 37,
// 41));
// Font headerFont = new Font(Font.HELVETICA, 12, Font.BOLD, new Color(73, 80,
// 87));
// Font bodyFont = new Font(Font.HELVETICA, 11, Font.NORMAL, new Color(52, 58,
// 64));
// Font labelFont = new Font(Font.HELVETICA, 10, Font.BOLD, new Color(108, 117,
// 125));
...
// document.add(value(offer.getSalary() != null ? "$ " +
// offer.getSalary().toPlainString() : "N/A", bodyFont));
// document.add(label("Start Date: ", labelFont));
// document.add(
// value(offer.getStartDate() != null ? offer.getStartDate().format(DATE_FORMAT)
// : "TBD", bodyFont));
// document.add(label("Offer Expiry: ", labelFont));
// document.add(
// value(offer.getExpiryDate() != null ?
// offer.getExpiryDate().format(DATE_FORMAT) : "N/A", bodyFont));
...
// "We look forward to welcoming you to our team. Please sign and return by the
// expiry date.",
// bodyFont);
...
// } catch (Exception e) {
// log.error("Failed to generate PDF for offer id={}: {}", offer.getId(),
// e.getMessage(), e);
